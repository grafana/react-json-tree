...
const defaultLabelRenderer: LabelRenderer = ([label], nodeType, expanded, expandable) => (
  <span className={`${styles.defaultLabelWrap} ${expandable ? styles.defaultLabelWrapExpandable : ''}`}>{label}:</span>
);
